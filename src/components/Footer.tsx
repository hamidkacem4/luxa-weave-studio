        ...
        <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
          <div className="flex flex-col items-center md:items-start gap-2">
            ...
            <a 
              ...
              className="flex items-center gap-2 text-xs text-gold-dark/70 hover:text-[#25D366] transition-all duration-300 group"
            >
               <span>This website was created by <strong>HAMID KACEM</strong></span>
